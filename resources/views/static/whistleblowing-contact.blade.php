            ...
            <div class="faq p-6 m-auto max-w-4xl flex flex-col space-y-3">
                @foreach ([
                 [
                        ...
                        'q' => '外部窓口を設置する必要性は？',
                        'a' => implode('<br />', [
                            '社内窓口だけですと、従業員が会社による調査の公正さ、経営陣からの独立性について不安を持ち、内部通報しにくいケースがあります。',
                            '従業員が内部通報をせず、行政機関やマスコミへ告発した場合、会社は自浄機会を与えられないまま、行政機関やマスコミを介してから不正行為を知ることになってしまいます。'
                        ]),
                    ],
                    [
                        'q' => '通報の受付方法は？',
                    ...
                    [
                        'q' => '通報者の氏名などは会社へ共有されますか？',
                        'a' => implode('<br />', [
                            '原則、通報者の氏名などは会社へ伝えません。',
                            'なお、通報内容によっては、氏名等を伝えずとも、通報者が特定されてしまう場合があります。',
                            'その場合は、通報者に対し、そのリスクを説明した上で、通報内容を会社へ伝えることの承諾を得ます。',
                        ]),
                    ],
                    [
                        'q' => '学校法人も内部通報を設置すべきですか？',
                        'a' => implode('<br />', [
                            '企業と同様、民間の学校法人も外部窓口を設置することが推奨されます。',
                            '学校法人に特有な通報内容の例として、研究費の不正使用や研究活動における不正行為、教員によるハラスメントなどが挙げられます。',           
                        ]),
                    ],
                    [
                        'q' => '弁護士以外の事務員が窓口対応することもありますか？',
                        'a' => '全て弁護士が対応します。',
                    ],
                    [
                        'q' => '外国人／英語の通報にも対応できますか？',
                        'a' => '英語での対応も可能です。',
                    ],
                ] as $item)
